...
//  TwitterFirebase
//
//  Created by Alphan Ogün on 1.09.2023.
//

import UIKit

private let reuseIdentifier = "AcitonSheetCell"
...
class ActionSheetLauncher: NSObject {
    ...
    func show() {
//        guard let window = UIApplication.shared.windows.first(where: {$0.isKeyWindow }) else { return } ----> DEPRECATED, use below:
